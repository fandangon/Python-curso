...
#Mostrando diferencias si los cursos durarian 10 horas
print(f'Ver 10 horas de este equivale a ver {otros_cursos_promedio * 100 // dalto_curso / 10} horas de otros cursos')
print(f'Ver 10 horas de este equivale a ver {dalto_curso * 100 // otros_cursos_promedio / 10} horas de este curso')
print("---------------------")
